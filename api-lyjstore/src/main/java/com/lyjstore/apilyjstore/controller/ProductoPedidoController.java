...
public class ProductoPedidoController {
    ...
    @GetMapping("/listarProductosPedidos/{idProducto}")
    public ResponseEntity listarProductosPedidos(@PathVariable("idProducto") Long idProducto){
        return new ResponseEntity(servicioProductoPedido.listarProductosPedidosPorIdProducto(idProducto),
                HttpStatus.OK);
    }
    ...
    @GetMapping("/preciosAGraficar")
    public ResponseEntity preciosAGraficar()
    {
        return new ResponseEntity(servicioProductoPedido.listarPreciosAGraficar(),
                HttpStatus.OK);
    }
}
